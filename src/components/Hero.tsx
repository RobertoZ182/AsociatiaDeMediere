  ...
  return (
    <section id="home" className="relative min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-40 right-10 w-72 h-72 bg-yellow-500 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-float" style={{ animationDelay: '2s' }}></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
        <div className="text-center">
          ...
          <h1 className={`text-4xl lg:text-7xl font-bold text-white mb-6 ${isVisible ? 'animate-slideInLeft' : 'opacity-0'}`} style={{ animationDelay: '0.2s' }}>
            <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent animate-gradient">Mediere</span> și{' '}
            <span className="bg-gradient-to-r from-green-400 to-emerald-400 bg-clip-text text-transparent animate-gradient">Reconciliere</span>
          </h1>
          
          <p className={`text-xl lg:text-2xl text-blue-100 mb-8 max-w-4xl mx-auto leading-relaxed ${isVisible ? 'animate-slideInRight' : 'opacity-0'}`} style={{ animationDelay: '0.4s' }}>
            Asociația de Mediere Comunitară Europeană a Romilor oferă servicii profesionale 
            de mediere comunitară extrajudiciară pentru rezolvarea conflictelor și promovarea înțelegerii în comunitate.
          </p>
          
          <div className={`flex flex-col sm:flex-row gap-6 justify-center mb-16 ${isVisible ? 'animate-fadeInUp' : 'opacity-0'}`} style={{ animationDelay: '0.6s' }}>
            <a
              href="#services"
            ...
            >
              <span className="relative z-10">Solicită Medierea</span>
            </a>
          </div>

          <div className={`grid md:grid-cols-3 gap-8 mt-20 ${isVisible ? 'animate-fadeInUp' : 'opacity-0'}`} style={{ animationDelay: '0.8s' }}>
            <div className="text-center group interactive-card bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/20">
              ...
              <h3 className="text-2xl font-semibold text-white mb-4 text-glow">Justiție Echitabilă</h3>
            ...
            <div className="text-center group interactive-card bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/20">
              ...
              <h3 className="text-2xl font-semibold text-white mb-4 text-glow">Comunitate Unită</h3>
              <p className="text-blue-100 leading-relaxed">
            ...
            <div className="text-center group interactive-card bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/20">
              ...
              <h3 className="text-2xl font-semibold text-white mb-4 text-glow">Respect & Demnitate</h3>
              <p className="text-blue-100 leading-relaxed">
